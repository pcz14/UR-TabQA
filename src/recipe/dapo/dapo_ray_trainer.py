    ...
    def fit(self):
        ...
        for epoch in range(self.config.trainer.total_epochs):
            for batch_dict in self.train_dataloader:
                ...
                with _timer("step", timing_raw):
                    ...
                    if self.config.algorithm.adv_estimator == AdvantageEstimator.REMAX:
                        with _timer("gen_max", timing_raw):
                            ...
                            reward_baseline_tensor = self.reward_fn(new_batch, step=self.global_steps)
                    ...
                    with _timer("reward", timing_raw):
                        ...
                        try:
                            ...
                            reward_tensor = self.reward_fn(new_batch, step=self.global_steps)
                ...
                metrics.update(compute_group_acc_metrics(scores=batch.non_tensor_batch['score'], index=batch.non_tensor_batch["uid"], 
                                                         reward_upper_bound=self.reward_upper_bound))
