...
def load_local_single_jsonl(data_dir):
    ...
    with open(data_dir, 'r', encoding='utf-8') as f:
        for line in f:
            ...
            # handle filepath_list which can be string or list
            filepath_list = line.get('filepath_list', [])
            if isinstance(filepath_list, str):
                filepath_list = [filepath_list]
            line_new['filepath_list'] = filepath_list
...
if __name__ == "__main__":
    ...
    parser.add_argument("--local_dir", default="./data/table/qwen3_v7_ch_20260119_debug")
    ...
    def make_map_fn(split):
        def process_fn(example, idx):
            ...
            data = {
                ...
                "extra_info": {"split": split, "index": idx, "question": example.pop("question"), "filepath_list": example.pop("filepath_list")},
            }
            print(data)
            return data
